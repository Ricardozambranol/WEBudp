...
function formatearMensaje(mensaje) {
  // El mensaje tiene el formato: "FH: 09/09/2023 18:51:03 Lat: 10.983294678547477 Lon: -74.78767871418991 Alt: 29.0"
  ...
  return {
    fecha: fechaParte.split(':')[1],
    hora: horaParte.split(':')[1],
